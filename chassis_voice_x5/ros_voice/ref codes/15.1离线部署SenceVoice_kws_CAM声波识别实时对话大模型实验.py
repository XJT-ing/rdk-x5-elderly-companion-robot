...
def audio_recorder():
    ...
    audio_buffer = []
    print("🎤 开始录音")
    os.system(f'pactl set-source-mute {mic_name} 0')  # 取消静音，确保所有语音可以正常获取
...
set_SV_enroll = "/home/pi/Largemodel/SpeakerVerification_DIR/enroll_wav"
# -------- CAM++声纹识别 -- 模型加载 --------
