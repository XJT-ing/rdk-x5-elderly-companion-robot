...
- `/red_circle_position` (`geometry_msgs/msg/PointStamped`)
- `/box_position` (`geometry_msgs/msg/PointStamped`)

YOLO BPU 检测节点 `detect_yolo_node` 会按类别发布：

- `/detect_yolo/apple_position` (`geometry_msgs/msg/PointStamped`)
- `/detect_yolo/banana_position` (`geometry_msgs/msg/PointStamped`)
- `/detect_yolo/bottle_position` (`geometry_msgs/msg/PointStamped`)
- `/detect_yolo/cake_position` (`geometry_msgs/msg/PointStamped`)
